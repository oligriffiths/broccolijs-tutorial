 ...
 * @param {Object} defaultModuleConfiguration I don't know what this does...
 * @returns {BroccoliMergeTrees}
 */
module.exports = function(appNode, configNode, modulePrefix, configPath, defaultModuleConfiguration) {
  ...
  defaultModuleConfiguration = defaultModuleConfiguration || require('./defaultModuleConfig');
